...
if ( get_the_time( 'c' ) != get_the_modified_time( 'c' ) ) {
	echo '<span class="d-none d-lg-inline-block d-xl-inline-block fa fa-refresh fa-fw"></span> <time class="d-none d-lg-inline-block d-xl-inline-block" itemprop="dateModified" datetime="' . get_the_modified_time( 'c' ) . '">' . get_the_modified_time( 'M jS, Y' ) . '</time>';
}
echo '</span> ';
edit_post_link();
echo '</li>';
